...
// givent a set of times, pick the times we want to create ticks for
// right now it's the start time, finish time and avg of the two (three ticks)
...
function tickLabels(date) { return moment(date).fromNow(); }
...
function LineGraph(props) {
  ...
  const bottomTickValues = tickTimeSelector(data.map(function(o){ return o.dt; }));
  console.log('btvs', bottomTickValues);

  var xAxis = d3.axisBottom(x)
      //.tickValues(tickTimeSelector)
      ...
      // .tickValues([new Date("2016-12-10T15:22:26.938Z"), new Date("2016-12-10T15:25:17.650Z")])
