...
// A function for having non overlapping labels
// that also make sense
function tickFormatter(date) { return moment(date).fromNow(); };
...
function LineGraph(props) {
  ...
  // Need to customize time interval (i.e. timeMinute)
      // and the corresponding formatter
  // d3.interval might be able to do the first.
      //.ticks(d3.timeMinute, 1)
      //.ticks(d3.timeMinute.every(1))
      //.tickFormat(d3.timeFormat("%a %d %H %M"))
      // AHA Setting ticks - now to figure out how to customize label (prob formatter)
      .tickFormat(tickFormatter)
      .tickValues([new Date("2016-12-10T15:21:26.938Z"), new Date("2016-12-10T15:25:17.650Z")]);
