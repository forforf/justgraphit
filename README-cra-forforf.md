# Getting Started with cra-forforf

[cra-forforf](https://github.com/forforf/cra-forforf) is almost a clone of the base
[Create React App](https://github.com/facebook/create-react-app).
The only difference is that the CRA Landing Page
